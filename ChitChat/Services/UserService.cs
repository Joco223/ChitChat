...
namespace ChitChat.Services {
	...
	public class UserService {
		...
		public async Task RegisterUser(Models.User registerUser, string password) {
			try {
				// Register user
				Session? session = await supabaseHandler.Client.Auth.SignUp(registerUser.Email, password);
